...
let s:bg6   = "242222"
let s:bg7   = "622222"
let s:tabselection = "606775"
let s:selection    = "aE1F29"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  call <SID>X("cCppOutWrapper","ca5c99" , "", "")
  call <SID>X("cPreCondit","3a9ce9" , "", "")
  call <SID>X("cDefine", s:define , "", "")
  call <SID>X("cPreConditMatch","3a9de9" , "", "")
  call <SID>X("cOperator","fa5c69" , "", "")
  call <SID>X("cConstant",s:orange , "", "")
  call <SID>X("cBlock","8afca9" , "555555", "")
  call <SID>X("cParen","eafc99" , "f55555", "")
  call <SID>X("cSpecial","2adc49" , "f55555", "")
